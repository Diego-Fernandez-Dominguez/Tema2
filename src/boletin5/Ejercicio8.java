...
public class Ejercicio8 {
	public static void main(String[] args) {
		...
		//Creo la variable que va a guardar si el usuario quiere terminar la partida o no
		String terminar;
		...
		do {
			...
			while((tirada1.equalsIgnoreCase("uno") || tirada1.equalsIgnoreCase("dos")  || tirada1.equalsIgnoreCase("tres") || tirada1.equalsIgnoreCase("cuatro") || tirada1.equalsIgnoreCase("cinco") || tirada1.equalsIgnoreCase("seis"))==false ) {
			...
			//repetira el siguiente bucle
			while((tirada2.equalsIgnoreCase("uno") || tirada2.equalsIgnoreCase("dos")  || tirada2.equalsIgnoreCase("tres") || tirada2.equalsIgnoreCase("cuatro") || tirada2.equalsIgnoreCase("cinco") || tirada2.equalsIgnoreCase("seis"))==false ) {
		...
		} while(terminar.equalsIgnoreCase("SI")==false);
